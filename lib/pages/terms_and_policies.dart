      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text("Vous devez accepter les termes et politiques pour poursuivre l'inscription."),
            actions: <Widget>[
              ElevatedButton(
                child: const Text("OK"),
                onPressed: () {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      CheckboxListTile(
        ...
        title: const Text("J'accepte les termes et conditions générales d'utilisation", style: TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold)),
      ),
      ElevatedButton(
